...
Процедура ПодтвердитьВыбор(Команда)
	...
	ОповеститьОВыборе(Новый Структура(
		"ДействиеВыбора, АдресОбъекта",
		Параметры.ДействиеВыбора, АдресОбъектаДополнительнойВыгрузки()
	));
...
Процедура НастройкиОтборов(Команда)
	...
	ВыбраныйВариант = ВыбратьИзМеню(СписокВариантов, Элементы.НастройкиОтборов);
...
Функция ПрочитатьСписокВариантовНастроекСервер()
	Возврат ЭтотОбъект().ПрочитатьПредставленияСпискаНастроек(Объект.УзелИнформационнойБазы);
КонецФункции
...
Функция АдресОбъектаДополнительнойВыгрузки()
	...
	ОбъектРезультат.Вставить("ДополнительнаяРегистрация", ДанныеФормыВЗначение(Объект.ДополнительнаяРегистрация, Тип("ТаблицаЗначений")));
