...
мТаблицаВозможныхОбменов = ПроцедурыОбменаДаннымиДополнительный.ПолучитьТаблицуВозможныхОбменовСРТ();
мСтруктураИнформацииОТекущейИнформационнойБазе = ПроцедурыОбменаДаннымиДополнительный.ПолучитьИнформациюОТекущейИнформационнойБазе();
