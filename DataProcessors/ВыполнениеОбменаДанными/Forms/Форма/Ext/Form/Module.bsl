...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВидТранспортаСообщений = Перечисления.ВидыТранспортаСообщенийОбмена.WS Тогда
		...
		НастройкиТранспортаWS = РегистрыСведений.НастройкиТранспортаОбмена.НастройкиТранспортаWS(УзелИнформационнойБазы);
...
Процедура УстановитьОбновление(Команда)
	Закрыть();
	ОбменДаннымиКлиент._ВыполнитьОбновлениеИнформационнойБазы();
КонецПроцедуры
...
Процедура СценарийОбменаЧерезВебСервис()
	...
	ТаблицаПереходовНоваяСтрока(1, "ОжиданиеСинхронизацииДанных",,,,,, Истина, "ОжиданиеПроверкиПодключенияПарольЗадан_ОбработкаДлительнойОперации");
