...
Процедура НастроитьНовыйОбменДаннымиНаСервереЧерезВнешнееСоединение(Отказ, НастройкаОтборовНаУзлеБазыКорреспондента, ЗначенияПоУмолчаниюНаУзлеБазыКорреспондента)
	...
	Элементы.ВыполнитьИнтерактивныйОбменДаннымиСейчас.Заголовок = СтрЗаменить(Элементы.ВыполнитьИнтерактивныйОбменДаннымиСейчас.Заголовок, "%Программа%", Объект.НаименованиеЭтойБазы);
