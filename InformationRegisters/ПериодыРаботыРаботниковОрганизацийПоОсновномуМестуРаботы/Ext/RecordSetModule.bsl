...
Процедура ВыполнитьПроверку(СообщатьОбОшибкахПериодов, УчитиыватьРегистратор)
	...
	ТаблицаПериодов = ОбщегоНазначения.ПериодыИспользованияРесурсов("ПериодыРаботыРаботниковОрганизацийПоОсновномуМестуРаботы", , , "Периоды.Физлицо В (&Физлица)", УчитиыватьРегистратор);
