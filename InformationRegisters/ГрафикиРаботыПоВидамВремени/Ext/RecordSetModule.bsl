...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если (Отбор.План.Значение = Ложь) И (Отбор.План.Использование)
		...
		Если ЗапросРасчетаОсновногоЗначения.Выполнить().Выбрать().Количество() = 1 Тогда
			...
			|	0 КАК ОсновноеЗначениеНормаПоГрафику,
			|	0 КАК ДополнительноеЗначениеНормаПоГрафику,
			|	ЗаписьНабора.Документ,
			|	ЗаписьНабора.ОсновноеЗначениеПолное,
			|	ЗаписьНабора.ДополнительноеЗначениеПолное,
			|	ЗаписьНабора.Месяц,
		...
		Иначе
			...
			|	РасчетОсновногоЗначения.ОсновноеЗначениеНормаПоГрафику КАК ОсновноеЗначениеНормаПоГрафику,
			|	РасчетОсновногоЗначения.ДополнительноеЗначениеНормаПоГрафику КАК ДополнительноеЗначениеНормаПоГрафику,
			|	ЗаписьНабора.Документ,
			|	ЗаписьНабора.ОсновноеЗначениеПолное,
			|	ЗаписьНабора.ДополнительноеЗначениеПолное,
			|	ЗаписьНабора.Месяц,
		...
		Для каждого ЗаписьНабора Из ЭтотОбъект Цикл
			...
			Если Не ТребуетсяНормаДругогоГрафика Тогда
				Если ЗаписьНабора.ВидУчетаВремени = Перечисления.ВидыУчетаВремени.ПоДням Или ЗаписьНабора.ВидУчетаВремени = Перечисления.ВидыУчетаВремени.ПоЧасам Тогда
					...
					ЗаписьНабора.ОсновноеЗначениеНормаПоГрафику = ЗаписьНабора.ОсновноеЗначение;
					ЗаписьНабора.ДополнительноеЗначениеНормаПоГрафику = ЗаписьНабора.ДополнительноеЗначение;
				КонецЕсли;
			Иначе 	
