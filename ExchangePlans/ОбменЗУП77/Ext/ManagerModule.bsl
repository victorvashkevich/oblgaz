...
Процедура ИнициализироватьРежимыВыгрузки() Экспорт
	...
	Запрос = Новый Запрос("
		...
		|ИЗ
		|	ПланОбмена.ОбменЗУП77 КАК ОбменУправлениеПредприятиемЗарплатаИУправлениеПерсоналом25
		|ГДЕ
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = '1С 7.7:Консолидированный учет'");
...
Функция ПодробнаяИнформацияПоОбмену() Экспорт
	...
	Возврат "ПланОбмена.ОбменЗУП77.Форма.ПодробнаяИнформация";
