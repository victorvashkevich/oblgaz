...
Функция СформироватьЗапросПоШапке(Режим)
	...
	|ИЗ
	|	Документ.РаботаВВыходныеДниОрганизаций КАК ОтсутствиеНаРаботеОрганизаций
	|
	|ГДЕ
...
Функция СформироватьЗапросПоРаботникиОрганизации(ВыборкаПоШапкеДокумента)
	...
	|	СтрокиДокумента.ДатаКомпенсации,
	|	СтрокиДокумента.ДвойнаяОплата,
	...
	|		Док.ДатаКомпенсации КАК ДатаКомпенсации,
	|		Док.ДвойнаяОплата КАК ДвойнаяОплата,
	...
	|	ИЗ
	|		Документ.РаботаВВыходныеДниОрганизаций.РаботникиОрганизации КАК Док
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.РаботаВВыходныеДниОрганизаций.РаботникиОрганизации КАК ПересекающиесяСтроки
...
Процедура ДобавитьСтрокуВДвиженияПоРегистрамСведений(ВыборкаПоШапкеДокумента, ВыборкаПоРаботникиОрганизации, 
	...
	Если ВыборкаПоРаботникиОрганизации.КонфликтноеСостояние=NULL Тогда
	...
	Если СтруктураПроведенияПоРегистрамСведений.Свойство(ИмяРегистра) Тогда
		Если (ВыборкаПоРаботникиОрганизации.ПричинаОтсутствия=Перечисления.СостоянияРаботникаОрганизации.Работает) и (Не ВыборкаПоРаботникиОрганизации.ДвойнаяОплата) Тогда
			Движение = Движения[ИмяРегистра].Добавить();
			...
			Движение.Организация	= ВыборкаПоШапкеДокумента.ГоловнаяОрганизация;
			Движение.Сотрудник	     = ВыборкаПоРаботникиОрганизации.Сотрудник;
			Движение.ДатаРаботы	 	 = ВыборкаПоРаботникиОрганизации.ДатаОкончания;		
			Движение.ДатаКомпенсации = ВыборкаПоРаботникиОрганизации.ДатаКомпенсации;		
		КонецЕсли;
