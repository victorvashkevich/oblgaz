...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	ЕстьФизЛицо                  = ПрисутствуетПоле("ФизЛицо");
	...
	ЕстьИнвалид                           = ПрисутствуетПоле("Инвалид");
	...
	ЕстьВидДеятельности                   = ПрисутствуетПоле("ВидДеятельности");
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "ВидДеятельности",           ЕстьВидДеятельности);
