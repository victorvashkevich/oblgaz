...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	Если ЗначениеПараметра.Значение = '00010101' Тогда
		ЗначениеПараметра.Значение = НачалоДня(ТекущаяДата());
...
Процедура ИнициализацияОтчета() Экспорт
	...
	Если ЗначениеПараметра <> Неопределено Тогда
		...
		ЗначениеПараметра.Значение =УправлениеПользователями.ПолучитьЗначениеПоУмолчанию(глЗначениеПеременной("глТекущийПользователь"), "ОсновнаяОрганизация");
