...
Процедура СообщитьИнформациюОПростойОшибке(Знач ИнформацияДляПользователя, ДанныеПротокола = "", Знач ОтображатьСообщениеОбОшибке = Истина) 
...
// Процедура отображает сообщение пользователю и записывает его в лог
Процедура СообщитьИнформациюОбОбмене(Знач ИнформацияДляПользователя, СтруктураОбменаДанными) 
...
Процедура ЗагрузитьСообщениеСИзменениямиДляУзла(СтруктураНастроекОбменаДанными, Знач ИмяФайлаОбменаДанными)
	...
	Если СтруктураНастроекОбменаДанными.ДанныеНастройки.OnLineОбмен Тогда
		...
		Попытка
			...
			ОтправитьСообщениеОбОшибкеДействийСОтложеннымПроведениемДокументов(СтруктураНастроекОбменаДанными, СтрокаСообщенияОбОшибкеОтложенныхДвижений);
...
Процедура ОтправитьСообщениеОбОшибкеДействийСОтложеннымПроведениемДокументов(СтруктураНастроекОбменаДанными, ТекстСообщения)
...
Функция ОпределитьНужноОтправлятьОтветныйПакет(СтруктураНастроекОбменаДанными, НужноПроверитьЧерезПочту)
...
Процедура ДействияПослеОбменаЧерезFTPРесурс(СтруктураНастроекОбменаДанными)
	...
	Если ОпределитьБылаУдачнноПроизведенаЗаписьДанных(СтруктураНастроекОбменаДанными) Тогда
		...
		НужноЗаписатьФайлНаFTP = ОпределитьНужноОтправлятьОтветныйПакет(СтруктураНастроекОбменаДанными, Ложь);
...
Процедура ДействияПослеОбменаЧерезПочтовыйРесурс(СтруктураНастроекОбменаДанными)
	...
	Если ОпределитьБылаУдачнноПроизведенаЗаписьДанных(СтруктураНастроекОбменаДанными) Тогда
		...
		НужноОтправлятьОтветноеПисьмо = ОпределитьНужноОтправлятьОтветныйПакет(СтруктураНастроекОбменаДанными, Истина);
...
Процедура ВыполнитьОбменДаннымиЧерезComСоединение(СтруктураНастроекОбменаДанными, ОбработкаОбменаПриемника = Неопределено)
	...
	СтруктураНастроекОбменаДанными.Вставить("РезультатОтложенныхДвиженийДокументов", ИтоговыйРезультатОтложенныхДвижений);
 	...
 	ОтправитьСообщениеОбОшибкеДействийСОтложеннымПроведениемДокументов(СтруктураНастроекОбменаДанными, ИтоговыйКомментарийПриОтложенномДвиженииДокументов);
