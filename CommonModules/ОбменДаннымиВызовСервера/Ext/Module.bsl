...
Процедура ЗафиксироватьВыполнениеВыгрузкиДанныхВРежимеДлительнойОперации(Знач УзелИнформационнойБазы, Знач ДатаНачала) Экспорт
	...
	СтруктураНастроекОбмена.Вставить("ВидОбмена", ОбменДаннымиСервер.ВидОбмена(УзелИнформационнойБазы));
...
Процедура ЗарегистрироватьУстранениеПроблемы(Источник, ТипПроблемы, Знач НовоеЗначениеПометкиУдаления) Экспорт
	...
	Иначе
		...
		СтруктураЗаписи = Новый Структура("ПроблемныйОбъект, ТипПроблемы", Источник, ТипПроблемы);
		ОбменДаннымиСервер.УдалитьНаборЗаписейВРегистреСведений(СтруктураЗаписи, "РезультатыОбменаДанными");
