...
Процедура ПриПолученииДанныхОтГлавного(ЭлементДанных, ПолучениеЭлемента, ОтправкаНазад, Отправитель) Экспорт
	...
	Если ОбменДаннымиВызовСервера.ЗагрузкаПараметровРаботыПрограммы() Тогда
...
Процедура ПроверитьВозможностьИзмененияНастроекОбменаДанными(Источник, Отказ) Экспорт
	...
	Если  Не Источник.ДополнительныеСвойства.Свойство("ПолучениеСообщенияОбмена")
		...
		ПодробноеПредставлениеОшибкиДляЖурналаРегистрации = НСтр("ru = 'Настройка обмена данными не может быть изменена.
												|Существуют зарегистрированные изменения данных для обмена.
												|Выполните обмен данными два раза и повторите попытку.'", КодОсновногоЯзыка
		);
		
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ПодробноеПредставлениеОшибки,,,, Отказ);
		
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Обмен данными'", КодОсновногоЯзыка), УровеньЖурналаРегистрации.Ошибка,,
			Источник.Ссылка, ПодробноеПредставлениеОшибкиДляЖурналаРегистрации);
