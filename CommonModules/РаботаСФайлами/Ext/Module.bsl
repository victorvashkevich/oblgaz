...
Процедура ОткрытьФормуСпискаФайловИИзображений(СтруктураДляСпискаИзображений, СтруктураДляСпискаДополнительныхФайлов, ОбязательныеОтборы, ФормаВладелец, ИмяСправочника = "ХранилищеДополнительнойИнформации") Экспорт
	...
	КонецЕсли; 
	Если СтруктураДляСпискаДополнительныхФайлов.Свойство("АктивнаяСтраница") Тогда
		Если СтруктураДляСпискаДополнительныхФайлов.АктивнаяСтраница Тогда
			ПанельЗакладок = ФормаФайлов.ЭлементыФормы.ПанельЗакладок;
			ПанельЗакладок.ТекущаяСтраница = ПанельЗакладок.Страницы.Файлы;
		КонецЕсли;
	КонецЕсли; 
